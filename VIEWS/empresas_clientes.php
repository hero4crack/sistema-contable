            ...
            <section class="content">
                <div class="card">
                    <div class="card-header" style="display: flex; justify-content: space-between; padding: 20px; border-bottom: 1px solid #e2e8f0;">
                        ...
                        <button class="primary-btn" style="background: #3b82f6; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; font-weight: bold;">
                    ...
                    <div class="table-wrapper">
                        ...
                        <?php while ($row = $result->fetch_assoc()) {?>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="state <?php echo (strtolower($row['estado_activo']) == 'activo') ? 'on' : 'off'; ?>"><?php echo $row['estado_activo']; ?></span></td>
